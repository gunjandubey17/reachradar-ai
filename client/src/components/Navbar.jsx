    ...
    <nav className="fixed top-0 w-full z-50 glass">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/audit" className="text-sm text-gray-300 hover:text-white transition">Audit</Link>
            <Link to="/pre-check" className="text-sm text-gray-300 hover:text-white transition">Pre-Post Checker</Link>
            <Link to="/daily-ideas" className="text-sm text-gray-300 hover:text-white transition">Daily Ideas</Link>
            ...
            {user ? (
              ...
              <Link to="/login" className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 rounded-lg text-sm font-medium transition">Sign In</Link>
            )}
          </div>
      ...
      {open && (
        <div className="md:hidden glass border-t border-white/10 px-4 py-4 space-y-3">
          ...
          <Link to="/daily-ideas" onClick={() => setOpen(false)} className="block text-gray-300 hover:text-white">Daily Ideas</Link>
