    ...
    <div className="pt-24 pb-16 max-w-3xl mx-auto px-4">
      ...
      {error && error === 'upgrade' ? (
        <div className="p-6 mb-6 bg-indigo-500/10 border border-indigo-500/30 rounded-xl text-center">
          ...
          <p className="text-gray-400 text-sm mb-4">Your first 5 free audits are used. Upgrade to Pro for unlimited audits, pre-post checker, AI image improver, and more.</p>
      ...
      <p className="text-center text-xs text-gray-600 mt-3">
        Your data is processed securely and never shared. Your first 5 audits are free.
      </p>
    </div>
  );
}
